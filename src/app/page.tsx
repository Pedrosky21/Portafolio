                  ...
                  {projectsToShow.map((proj, index) => (
                    ...
                    >
                      ...
                      <div className="w-full">
                        ...
                        ></Image>
                        <button className="absolute right-27 bottom-10 hidden rounded-xl border-2 border-black bg-purple-600 px-3 py-1 text-xl text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                          Mas info...
                        </button>
                      </div>
                    </div>
